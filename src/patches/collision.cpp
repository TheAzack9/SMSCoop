...
namespace SMSCoop {
	...
	void BounceMario(TMario* mario1, TMario* mario2){
		...
		//gpMSound->startSoundActorSpecial(0x78bf, &(mario1->mTranslation), 0.0f, 0.0f, 0.0f, )
		//mario1->startVoice(0x7930);
		//MSoundSESystem::MSoundSE::startSoundActorInner(0x7930, &gpMSound->mSound, )
			/*gpMSound->startMarioVoice()
		startSoundActorInner__Q214MSoundSESystem8MSoundSEFUlPP8JAISoundP8JAIActorUlUc(0x7930, &(mario1->mTranslation));*/
		startSoundActorWithInfo__Q214MSoundSESystem8MSoundSEFUlPC3VecP3VecfUlUlPP8JAISoundUlUc(0X81B, &(mario1->mTranslation), 0, 0.0f, 3, 0, 0, 0, 4);
